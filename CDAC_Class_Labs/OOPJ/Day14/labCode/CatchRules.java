class CatchRules{
    public static void main(String[] args){
		...
		catch(Exception e){ // all general acception classes must come below the specific ones
			
		}
		
		catch(ArithmeticException e){ // error because the expception has already been caught
